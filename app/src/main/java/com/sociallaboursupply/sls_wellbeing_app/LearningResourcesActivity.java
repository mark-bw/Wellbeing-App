...
public class LearningResourcesActivity extends SubActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resources_directory);
        setTitle(R.string.learning_resource_page_heading);
...
//        db.openDatabase();
        ...
        ResourceAdapter resourceAdapter = new ResourceAdapter(db, LearningResourcesActivity.this);
